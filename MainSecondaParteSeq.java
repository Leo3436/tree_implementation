...
public class MainSecondaParteSeq {

    static final int NMIN = 1000;
    static final int NMAX = 100000;
    static final int NMEDIA = 5;
    ...
    private static long executeBSTOperation(BST binaryTree, int n ) {
        ...
        /*
        Gestisco il caso in cui il numero di chiamate ricorsive sia troppo elevato e generi
        un errore di StackOverflow. Nel caso in cui si riscontri questa exception verrà restituito come tempo di
        esecuzione 0.
        L'errore di StackOverFlow si verifica nel worst case del BST nel momento in cui il numero di chiamate
        ricorsive è troppo elevato
         */
        try {
            int k = 0;
            int j = 0;
    ...
    private static long executeRBTOperation(RBT rbtTree, int n ) {
        ...
        for(int i = 0; i < MAXNODO; i++) {
            redBlackNodi[i] = new RedBlackNode(i+1);
        }
